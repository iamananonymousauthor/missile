...
class SpatialMultiplexingExecutor : public ExecutorBase {
public:
    SpatialMultiplexingExecutor();
    ~SpatialMultiplexingExecutor();
    ...
    Status execute_to_launch(int &launch_step_offset, GPUStream_t stream, int TPC_request_num_cores, int TPC_limit_num_cores);
    ...
    virtual Status launch_kernel(int op_offset, int kernel_offset, GPUStream_t stream, int TPC_request_num_cores, int TPC_limit_num_cores) override;
